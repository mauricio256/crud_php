...
$cod_aluno = $_GET['id'];
    ...
    $query = $conn->query("SELECT * FROM aluno WHERE id = $cod_aluno");
...
<html lang="pt-br">
  ...
  <body>
        <div class="m-sm-5 m-3">
              <h1>Editar</h1> <hr> 
            <?php foreach($aluno as $iten){ ?>
                      
                <form action="processa/edita_aluno.php" method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="modal-footer">
                          <a href="aluno.php" type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancelar</a>
